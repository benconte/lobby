...
function Amenities() {
    return (
        <div className="my-8">
            <h3 className="font-bold text-xl text-[var(--lightblue)]">Amenities</h3>
            <div className='w-full my-3 grid grid-flow-row-dense grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4'>
